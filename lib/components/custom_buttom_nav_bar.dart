      ...
      child: SafeArea(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(
                icon: SvgPicture.asset(
                  "assets/icons/trand.svg",
                  color: MenuState.trand == selectedMenu
                      ? kPrimaryColor
                      : inActiveIconColor,
                ),
                onPressed: () =>
                    Navigator.pushNamed(context, TrandingScreen.routeName),
              ),
              IconButton(
                icon: SvgPicture.asset(
                  "assets/icons/user_fix.svg",
